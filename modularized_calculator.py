...
def test(line):
    ...
    first_answer = evaluate_times_and_divide(tokens)
    if first_answer == None:
        print("ZeroDivisionError")
        return 
    actual_answer = evaluate_plus_and_minus(first_answer)
...
while True:
    ...
    line = input()
    tokens = tokenize(line)
    answer = evaluate_times_and_divide(tokens)
    actual_answer = evaluate_plus_and_minus(answer)
    print("answer = %f\n" % actual_answer)